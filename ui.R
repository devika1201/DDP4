...
shinyUI(
    navbarPage("Shiny Application",
               ...
               tabPanel("About the application",
                        p("This shiny app has been created as part of Coursera Developing Data Products project."),
                        p("You have to select an option from the drop box and then graphs will be displayed as per."),
                        p("the selected option.")
               ),
               tabPanel("Go back to my Github repository",
                        a("https://github.com/devika1201/DDP4"),
                        hr(),
                        h4("Thank you.Visit Again!!") 
               )
    )
)